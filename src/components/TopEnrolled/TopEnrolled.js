            ...
            <Card className="text-center">
                <Card.Body>
                    ...
                    <div>
                        ...
                        <ProgressBar striped variant="secondary" label={'Javascript'} now={20} />
                        <ProgressBar striped variant="primary" label={'Digital Marketing'} now={60} />
                        <ProgressBar striped variant="danger" label={'Python'} now={80} />
                    </div>
                </Card.Body>
                <Card.Footer className="text-muted">Last updated 3 minutes ago</Card.Footer>
            </Card>
        </div>
    );
};
